...
export interface B2AppContract {
  change_binding(request: BindingChangeRequest): Promise<LifecycleReceipt | ContractError>;
  publish(request: PublishRequest): Promise<MemoryHead | ContractError>;
  query_projections(request: ProjectionQuery): Promise<ProjectionPage | ContractError>;
  transfer_dataset(request: DatasetTransfer): Promise<Dataset | ContractError>;
  uninstall(request: UninstallRequest): Promise<LifecycleReceipt | ContractError>;
}
