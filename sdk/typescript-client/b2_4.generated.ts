...
export const B24_SCHEMA_DIGEST = "619168f06db1d9df2ba24403a3c29d662a6daa467a4a8d0d065693d04ade1933" as const;
...
export interface CollaborationDirectory {
  ...
  graph_runs?: Array<CollaborationGraphRun>;
  graph_runs_has_more?: boolean;
  graph_runs_next_cursor?: string | null;
}

export interface CollaborationGraphRun {
  id: string;
...
export interface GetCollaborationDirectoryOptions {
...
export class B24Client {
  ...
  async getCollaborationDirectory(options: GetCollaborationDirectoryOptions = {}): Promise<CollaborationDirectory> {
    const response = await this.requestOperation(B24_OPERATIONS["getCollaborationDirectory"], { query: { "workspace": options.workspace === undefined ? undefined : String(options.workspace), "cursor": options.cursor === undefined ? undefined : String(options.cursor) }, headers: { Accept: "application/json" } });
