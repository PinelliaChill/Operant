...
CONTRACT_VERSION = 'operant-b2-contract.v1'
SCHEMA_DIGEST = '1f0c3327dfcad55b3cf301268f0518da29ba43bfaba4905c4d399fbd374f37b7'
...
class B2AppContract(Protocol):
    async def change_binding(self, request: BindingChangeRequest) -> LifecycleReceipt | ContractError: ...
    async def publish(self, request: PublishRequest) -> MemoryHead | ContractError: ...
    async def query_projections(self, request: ProjectionQuery) -> ProjectionPage | ContractError: ...
    async def transfer_dataset(self, request: DatasetTransfer) -> Dataset | ContractError: ...
    async def uninstall(self, request: UninstallRequest) -> LifecycleReceipt | ContractError: ...
