...
SCHEMA_PATH = ROOT / "sdk/protocol/schema/operant-b2-3.openapi.json"
DIGEST_PATH = ROOT / "sdk/protocol/schema/operant-b2-3.openapi.sha256"
TS_PATH = ROOT / "sdk/typescript-client/b2_3.generated.ts"
PY_PATH = ROOT / "sdk/python_client/b2_3_generated.py"
PROTOCOL_VERSION = "b2-3.v1"
EXPECTED_OPERATION_IDS = {"negotiateProtocol", "getManagement", "executeManagementCommand"}
OPERATION_MAP = {
    "negotiateB23": "negotiateProtocol",
    "getB23Management": "getManagement",
    "executeB23ManagementCommand": "executeManagementCommand",
}
...
def _document() -> dict[str, Any]:
    ...
    selected["/v1/protocol/b2-3"]["get"]["responses"]["200"]["content"]["application/json"][
        "schema"
...
def _b2_names(source: str) -> str:
    renamed = (
        source.replace("PHASE1E", "B23")
        .replace("Phase1E", "B23")
        .replace("phase1e", "b23")
        .replace("Phase 1E", "B23")
    )
    ...
    return renamed.replace("operant-b23.openapi", "operant-b2-3.openapi").replace(
        "generate_b23.py", "generate_b2_3.py"
    )
