...
SCHEMA_PATH = ROOT / "sdk/protocol/schema/operant-b2-4.openapi.json"
DIGEST_PATH = ROOT / "sdk/protocol/schema/operant-b2-4.openapi.sha256"
TS_PATH = ROOT / "sdk/typescript-client/b2_4.generated.ts"
PY_PATH = ROOT / "sdk/python_client/b2_4_generated.py"
...
OPERATION_MAP = {
    "negotiateB24": "negotiateProtocol",
    "getB24Collaboration": "getCollaborationDirectory",
    "getB24Context": "inspectContext",
    "executeB24Command": "execute",
}
...
def _document() -> dict[str, Any]:
    ...
    selected["/v1/protocol/b2-4"]["get"]["responses"]["200"]["content"]["application/json"][
        "schema"
...
def _b2_names(source: str) -> str:
    renamed = (
        source.replace("PHASE1E", "B24")
        .replace("Phase1E", "B24")
        .replace("phase1e", "b24")
        .replace("Phase 1E", "B24")
    )
    ...
    return renamed.replace("operant-b24.openapi", "operant-b2-4.openapi").replace(
        "generate_b24.py", "generate_b2_4.py"
    )
