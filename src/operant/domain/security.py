...
class Capability(str, Enum):
    ...
    REMOTE_CONTROL_OBSERVE = "remote.control.observe"
    REMOTE_CONTROL_COMMAND = "remote.control.command"
    REMOTE_CONTROL_APPROVE = "remote.control.approve"
    REMOTE_TARGET_READ = "remote.target.read"
    REMOTE_TARGET_EXEC = "remote.target.exec"
